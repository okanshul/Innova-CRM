document.addEventListener('DOMContentLoaded', function () {
    ...
    function getPriorityBadgeClass(priority) {
        ...
        if (p === 'urgent') return `<span class="badge rounded-pill fw-semibold px-3 py-1 badge-status-urgent" style="font-size: 0.75rem;">URGENT</span>`;
        if (p === 'high') return `<span class="badge rounded-pill fw-semibold px-3 py-1 badge-status-high" style="font-size: 0.75rem;">HIGH</span>`;
        if (p === 'medium') return `<span class="badge rounded-pill fw-semibold px-3 py-1 badge-status-medium" style="font-size: 0.75rem;">MEDIUM</span>`;
        return `<span class="badge rounded-pill fw-semibold px-3 py-1 badge-status-low" style="font-size: 0.75rem;">LOW</span>`;
    }

    function getStatusBadgeClass(s) {
        if (s === 'completed') return `<span class="badge rounded-pill fw-semibold px-3 py-1 badge-status-completed" style="font-size: 0.75rem;">Completed</span>`;
        if (s === 'in_progress') return `<span class="badge rounded-pill fw-semibold px-3 py-1 badge-status-in-progress" style="font-size: 0.75rem;">In Progress</span>`;
        if (s === 'cancelled') return `<span class="badge rounded-pill fw-semibold px-3 py-1 badge-status-cancelled" style="font-size: 0.75rem;">Cancelled</span>`;
        return `<span class="badge rounded-pill fw-semibold px-3 py-1 badge-status-pending" style="font-size: 0.75rem;">Pending</span>`;
    }
