...
<head>
    ...
    <title>InnovaCRM - Add Staff</title>
        ...
        <main class="flex-grow-1 p-4">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb mb-0 align-items-center" style="font-size: 0.8rem;">
                    ...
                    <li class="breadcrumb-item active text-body-emphasis fw-semibold" aria-current="page">Add Staff</li>
                </ol>
            </nav>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden bg-body">
                        ...
                        <div class="card-header border-bottom bg-body px-4 py-3 d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <h4 class="fw-bold mb-0 text-body-emphasis">Add New Staff</h4>
                                    <p class="text-secondary small mb-0">Fill in the details below to register a new staff.</p>
                                </div>
                            </div>
                        ...
                        <form id="staffCreateForm" action="{{ route('staff.store') }}" method="POST">
                            ...
                            <div class="tab-content" id="createStaffTabsContent">
                                ...
                                <div class="tab-pane fade show active p-4" id="details-pane" role="tabpanel" aria-labelledby="details-tab" tabindex="0">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="e.g. Michael Smith">
                                            @error('name')
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="michael.smith@innovacrm.com">
                                            @error('email')
                                                <div class="invalid-feedback ps-2">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label fw-medium small text-secondary ps-2">
                                                <i class="fa-solid fa-lock text-secondary me-1"></i> Password <span class="text-danger">*</span>
                                            </label>
                                            <div class="position-relative">
                                                <input type="password" class="form-control pe-5 @error('password') is-invalid @enderror" name="password" minlength="8" placeholder="At least 8 characters">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" placeholder="+1 (555) 123-4567">
                                            @error('phone')
                                                <div class="invalid-feedback ps-2">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('position') is-invalid @enderror" name="position" value="{{ old('position') }}" placeholder="e.g. Sales Executive">
                                            @error('position')
                                                <div class="invalid-feedback ps-2">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="date" class="form-control @error('joined_date') is-invalid @enderror" name="joined_date" value="{{ old('joined_date', date('Y-m-d')) }}">
                                            @error('joined_date')
                                                <div class="invalid-feedback ps-2">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="tab-pane fade p-4" id="permissions-pane" role="tabpanel" aria-labelledby="permissions-tab" tabindex="0">
                                    <div class="mb-3">
                                        ...
                                        <p class="text-secondary small mb-0">Grant or revoke specific individual permissions overriding or supplementing role defaults.</p>
                                    </div>
                            ...
                            <div class="card-footer border-top bg-body px-4 py-3 d-flex align-items-center justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-purple-primary rounded-3 px-4 py-2 fw-semibold">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
