        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm rounded-4 bg-body">
                ...
                <form id="staffCreateForm" action="{{ route('crm.api.staff.store') }}" method="POST">
                    ...
                    <!-- Nav Tabs -->
                    <ul class="nav nav-tabs custom-form-tabs px-3 pt-2 bg-body flex-nowrap" id="createStaffTabs" role="tablist">
                    ...
                    <div class="tab-content" id="createStaffTabsContent">
                        ...
                        <div class="tab-pane fade show active p-3" id="details-pane" role="tabpanel"
                            ...
                            <div class="row">
                                ...
                                <x-form.input class="col-12 col-md-6 mb-3" type="password" name="password" label="Password"
                                ...
                                <x-form.datetime-picker class="col-12 col-md-3 mb-3" type="date" name="joined_date" label="Joined Date"
