<div class="d-flex justify-content-between align-items-start py-2 px-0 bg-transparent opacity-90">
    <div class="d-flex gap-2 align-items-start">
        <div class="avatar bg-{{ $activity['color'] }} text-white rounded-circle d-flex align-items-center justify-content-center flex-shrink-0 fw-bold mt-0.5 shadow-sm"
        ...
        <div>
            <p class="mb-1 text-body-emphasis" style="font-size: 0.775rem; line-height: 1.25;">
                ...
                <span class="text-secondary fw-normal ms-0.5">{{ $activity['action'] }}</span>
            </p>
